...
# Return
- `Tuple{Vector{Vector{Integer}}, Vector{Vector{AbstractFloat}}}`: Tuple of neighbours and straight line euclidean distances from each point `([[neighbours]...], [[dists]...])`.
"""
function nearest_node(g::OSMGraph,
                      points::Vector{GeoLocation},
                      n_neighbours::Integer=1
                      )::Tuple{Vector{Vector{Integer}},Vector{Vector{AbstractFloat}}}
    cartesian_locations = transpose(LightOSM.to_cartesian(points))
